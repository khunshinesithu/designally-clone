...
/**
 * Clone of https://designally.co/cookie-policy/.
 *
...
const page = (legalPages as LegalPageData[]).find((p) => p.slug === "cookie-policy");

export const metadata: Metadata = {
  title: "Cookie Policy | DESIGNALLY",
  alternates: { canonical: "https://designally.co/cookie-policy/" },
};
